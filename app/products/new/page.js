  ...
  return (
    <main>
      ...
      <form action={registerProduct}>
        ...
        <label>상품 설명<textarea name="info" rows="6" required /></label>
        <label>상품 이미지 URL<textarea name="images" rows="5" placeholder="한 줄에 하나씩, 최대 5개" required /></label>
        ...
        <p>등록 후 가격은 24시간 동안 유지되며, 이후 실제 거래가와 반응 데이터를 기준으로 최저 가격 범위 안에서 평가됩니다.</p>
